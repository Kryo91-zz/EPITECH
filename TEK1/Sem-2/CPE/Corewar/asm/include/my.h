...
*/
    ...
    int get_line_no_comment(FILE *filestream, char **line_ptr, char comm_char);
    ...
    void *tab_slice(void *tab, const size_t  start, const size_t  end);
        ...
        void my_flag_upper_s(va_list ap);
        void my_flag_upper_x(va_list ap);
