...
typedef struct {
    const size_t        __size__;   // ex01 taille mémoire de la classe
    const char          *__name__;  // ex01 nom de la classe
    ctor_t              __ctor__;   // ex01 Constructor -> permet d'initialiser la classe
    dtor_t              __dtor__;   // ex01 Destructor -> permet de détruire la classe et free la mémoire
